...
public class GunsPlusPlayer extends Shooter {
	...
	public void zoom(Gun g) {
		if(!player.hasPermission("gunsplus.zoom." + g.getName().toLowerCase().replace(" ", "_"))) return;
	...
	public void fire(Gun g) {
		if(!player.hasPermission("gunsplus.fire." + g.getName().toLowerCase().replace(" ", "_"))) return;
	...
	public void reload(Gun g) {
		if(!player.hasPermission("gunsplus.reload." + g.getName().toLowerCase().replace(" ", "_"))) return;
