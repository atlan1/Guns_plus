package me.atlan1.GunPack.Classes;

import java.util.Random;
import java.util.ArrayList;

import me.atlan1.GunPack.GunPack;
...
public class Gun extends GenericCustomItem{
	...
	public Gun(Plugin pl, int dmg, int rng, int rtime, int dtime, int nbrs, double rec,double knock, ArrayList<ItemStack>  amm, int zoom, String sSound, String rSound, int hdmg, int spready, int ai, int ao,int cri, String zt,String pro,double prospeed, ArrayList<Effect> e, GunPack instance, String url, String name){
		super(pl, name, url);
		damage= dmg;
		range = rng;
		ammo = amm;
